...
## CUSTOM
@export var disable_attenuation: bool = true:
	set(value):
		disable_attenuation = value
		_warning_start_time_with_end_time()
		_warning_property_null(disable_attenuation, "ATTENUATION")
...
## Set Random Pitch Offset
@export var random_pitch_offset: Vector2:
	set(value):
		random_pitch_offset = value
		_warning_start_time_with_end_time()
		_warning_property_null(random_pitch_offset, "RANDOM_PITCH_OFFSET")
